...
d) Para obtener el tiempo en el que ocurre la concentración máxima por paciente, se puede utilizar la siguiente consulta SQL:
   ...
   ```
    ...
    Además, para garantizar que se devuelve una única fila por sujeto en caso de que existan varios tiempos con la misma concentración máxima, se añade un criterio adicional que selecciona el menor tiempo asociado a dicho valor máximo.De este modo, el resultado no solo identifica la concentración máxima de cada paciente, sino también el primer instante temporal en el que se alcanza.
